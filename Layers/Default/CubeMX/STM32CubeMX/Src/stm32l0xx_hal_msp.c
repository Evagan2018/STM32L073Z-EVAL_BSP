...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA5     ------> ADC_IN5
    */
    GPIO_InitStruct.Pin = PRESSURE_Pin|ADC_IN5_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC_IN5
    */
    HAL_GPIO_DeInit(GPIOA, PRESSURE_Pin|ADC_IN5_Pin);
...
void HAL_COMP_MspDeInit(COMP_HandleTypeDef* hcomp)
{
  ...
  /* USER CODE END COMP2_MspDeInit 0 */
    ...
    PB4     ------> COMP2_INP
    */
    HAL_GPIO_DeInit(DET_COMP2_OUT_GPIO_Port, DET_COMP2_OUT_Pin);

    HAL_GPIO_DeInit(GPIOB, DET_COMP2_INM_Pin|DET_COMP2_INP_Pin);
...
void HAL_SMBUS_MspDeInit(SMBUS_HandleTypeDef* hsmbus)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(TempSensor_INT_GPIO_Port, TempSensor_INT_Pin);
...
void HAL_LPTIM_MspDeInit(LPTIM_HandleTypeDef* hlptim)
{
  ...
  /* USER CODE END LPTIM1_MspDeInit 0 */
    ...
    PC0     ------> LPTIM1_IN1
    */
    HAL_GPIO_DeInit(DET_LPTIM_CH1_GPIO_Port, DET_LPTIM_CH1_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PD12     ------> LPUART1_RTS
    */
    HAL_GPIO_DeInit(GPIOD, LPUART_TX_Pin|LPUART_RX_3V3_Pin|LPUART_CTS_3V3_Pin|LPUART_RTS_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, USART2_CTS_3V3_Pin|USART2_RTS_Pin|USART2_TX_Pin|USART2_RX_3V3_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PE9     ------> USART4_RX
    */
    HAL_GPIO_DeInit(GPIOE, USART4_TX_Pin|USART4_RX_3V3_Pin);
