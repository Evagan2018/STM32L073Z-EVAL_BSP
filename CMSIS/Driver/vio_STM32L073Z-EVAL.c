/******************************************************************************
 * @file     vio_STM32L073Z-EVAL.c
 * @brief    Virtual I/O implementation for board STM32L073Z-EVAL
 * @version  V1.0.0
...
/*! \page vio_STM32L073Z-EVAL Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red       (LD3)  | PD1
| vioLED1       | vioSignalOut.1 | LED green     (LD1)  | PE4
| vioLED2       | vioSignalOut.2 | LED blue      (LD4)  | PE7
| vioLED3       | vioSignalOut.3 | LED orange    (LD2)  | PE5
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTD(1),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTE(4),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED2,    GPIO_PIN_ID_PORTE(7),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED3,    GPIO_PIN_ID_PORTE(5),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
