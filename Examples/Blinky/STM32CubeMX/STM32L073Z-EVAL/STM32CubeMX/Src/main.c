...
static void MX_I2C1_SMBUS_Init(void)
{
  ...
  hsmbus1.Init.Timing = 0x00805C87;
  ...
  hsmbus1.Init.SMBusTimeout = 0x00008124;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : EXT_RESET_Pin TFT_CS_Pin */
  ...
  /*Configure GPIO pins : SPI1_MOSI_DIR_Pin MFX_WKUP_Pin */
  ...
  /*Configure GPIO pin : TST_MOSI_DIR_Pin */
  ...
  /*Configure GPIO pins : LED3_Pin DET_PULSE_Pin */
